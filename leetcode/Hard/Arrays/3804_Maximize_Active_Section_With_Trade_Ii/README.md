...
[![Topic: Array](https://img.shields.io/badge/Topic-Array-blue?style=flat-square)](https://leetcode.com/tag/array/) [![Topic: String](https://img.shields.io/badge/Topic-String-blue?style=flat-square)](https://leetcode.com/tag/string/) [![Topic: Binary Search](https://img.shields.io/badge/Topic-Binary Search-blue?style=flat-square)](https://leetcode.com/tag/binary-search/) [![Topic: Segment Tree](https://img.shields.io/badge/Topic-Segment Tree-blue?style=flat-square)](https://leetcode.com/tag/segment-tree/)

- **LeetCode Link**: [https://leetcode.com/problems/maximize-active-section-with-trade-ii/](https://leetcode.com/problems/maximize-active-section-with-trade-ii/)
- **Problem ID**: 3804
- **Language**: Java
